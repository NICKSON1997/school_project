...
<head>
  ...
  <title>Student Registration // Zetech University</title>
    ...
    <nav class="navbar navbar-ct-transparent navbar-fixed-top" role="navigation-demo" id="register-navbar">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="http://www.zetech.ac.ke/">Zetech University</a>
        </div>
    ...
    <div class="wrapper">
        <div class="register-background"> 
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1 ">
                            <div class="register-card">
                                ...
                                <form action='./student/dashboard.php' name ="student" method = "post">
            ...
            <div class="footer register-footer text-center">
                    <h6>&copy; 2022, made with <i class="fa fa-heart heart"></i> by Nickson </h6>
            </div>
        </div>
    </div>      
