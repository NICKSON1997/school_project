...
$update_query = mysqli_query($conn,"INSERT INTO Subjects (Department,Course_Code,Course_Title,Course_Credit) VALUES ('$Department','$Course_Code','$Course_Title','$Course_Credit')");
